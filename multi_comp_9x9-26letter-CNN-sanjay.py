...
def printLetter (trainingDataList, gridHeight, gridWidth):    
...
#    # 3x3 grid mask to run over the expandedLetter array
#    for i in len(expandedLetterArray):
#        for j in len(expandedLetterArray[i]):
            


    # return 81 element letter array
...
# This procedure has a list, but it is an empty list; welcome().
    ...
    os.chdir("C:/EDUCATION/NWU/490 - Deep Learning/Week 7")
...
# Parameter definitions, to be replaced with user inputs
    alpha = 1.0
    eta = 1    
    maxNumIterations = 50000    # temporarily set to 10 for testing
    epsilon = 0.01
